  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        'plasma-pulse': '0 0 8px hsl(var(--primary)/0.3), 0 0 12px hsl(var(--primary)/0.2), 0 0 16px hsl(var(--primary)/0.1)',
      ...
      keyframes: {
        ...
        'plasma-pulse': {
          '0%, 100%': { boxShadow: '0 0 6px hsl(var(--primary)/0.1), 0 0 10px hsl(var(--primary)/0.2), 0 0 14px hsl(var(--primary)/0.1)' },
          '50%': { boxShadow: '0 0 10px hsl(var(--primary)/0.2), 0 0 16px hsl(var(--primary)/0.3), 0 0 22px hsl(var(--primary)/0.2)' },
        },
      },
      animation: {
